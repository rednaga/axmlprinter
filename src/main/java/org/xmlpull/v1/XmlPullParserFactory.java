 ...
 * META-INF/services/org.xmlpull.v1.XmlPullParserFactory resource that should contain a comma
 * separated list of class names of factories or parsers to try (in order from left to the right).
 * If none found, it will throw an exception.
 * 
 * <br />
